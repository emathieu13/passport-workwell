...
Strategy.prototype.authenticate = function(req, options) {
    ...
    if (req && req.query && req.query.servicetoken && req.query.email) {
        ...
        var now = 1509707115; //parseInt(new Date().getTime() / 1000);
        const signature = "cpkglq/DOhDebvxxKn7/iVxqDYj/tFUljkB6sgnZ5Y8=";crypto.createHmac('sha256', this._service_secret).update(this._service_id + now).digest("base64");
